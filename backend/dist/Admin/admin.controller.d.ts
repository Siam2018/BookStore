...
export declare class AdminController {
    ...
    updateByUsername(username: string, updateData: Partial<AdminDto>): Promise<import("./admin.entity").AdminEntity | {
        message: any;
    } | null>;
    ...
    updateImage(username: string, file: Express.Multer.File): Promise<import("./admin.entity").AdminEntity | {
        message: any;
    } | null>;
